    ...
    @foreach($dishTypes as $dishType)
        ...
        <table class="w-full border mt-2 table-fixed">
            <thead class="bg-gray-200">
                <tr>
                    <th class="p-2 w-1/5">Nr</th>
                    <th class="p-2 w-1/5">Naam</th>
                    <th class="p-2 w-1/5">Beschrijving</th>
                    <th class="p-2 w-1/5">Prijs</th>
                    <th class="p-2 w-1/5">Acties</th>
                </tr>
            </thead>
            <tbody>
                ...
                @empty
                    <tr>
                        <td colspan="5" class="p-2">Nog geen gerechten</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
