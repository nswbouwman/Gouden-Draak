<x-app-layout>
    <x-slider-with-border-tablet>
        ...
        <h1 class="text-xl font-bold">Bedankt voor uw bezoek aan Gouden Draak!</h2>
            <p class="mb-4 text-lg">We zouden het waarderen als u ons helpt verbeteren door deze korte vragenlijst in te
                vullen.</p>
            <form method="POST" action="{{ route('form.submit') }}">
                @csrf
                <div class="flex flex-col items-center mb-4">
                    <label class="font-bold text-lg" for="experience">Hoe was uw ervaring?</label>
                    <textarea class="w-[80%]" id="experience" name="experience" rows="3" class="form-control" required></textarea>
                </div>
                <div class="flex flex-col items-center mb-4">
                    <label class="font-bold text-lg" for="atmosphere">Hoe beoordeelt u de sfeer?</label>
                ...
                <div class="flex flex-col items-center mb-4">
                    <label class="font-bold text-lg" for="food">Hoe beoordeelt u het eten?</label>
                ...
                <div class="flex flex-col items-center mb-4">
                    <label class="font-bold text-lg" for="service">Hoe beoordeelt u de service?</label>
                ...
                <div class="flex flex-col items-center mb-4">
                    <label class="font-bold text-lg" for="remark">Heeft u nog opmerkingen of tips voor ons?</label>
                ...
                <div class="flex flex-col items-center mb-4" x-data="{ rating: 5 }">
                    <label class="font-bold text-lg" for="rating">Hoe zou u uw bezoek beoordelen?</label>
                ...
                <button type="submit"
                    class="text-lg bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded">Verzenden</button>
            </form>
    </x-slider-with-border-tablet>
</x-app-layout>
